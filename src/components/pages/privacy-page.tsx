  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 flex-grow overflow-y-auto prose prose-sm max-w-none">
        ...
        <p>Kebijakan Privasi ini menjelaskan bagaimana informasi Anda dikumpulkan, digunakan, dan dibagikan saat Anda menggunakan aplikasi Berez Kitchen ("Aplikasi").</p>
