...
import { Receipt, CheckCircle, AlertCircle, Clock, Frown } from "lucide-react";
      ...
      <div className="space-y-4">
        {cashierTransactions.length === 0 ? (
           <div className="text-center py-20 flex flex-col items-center gap-4">
             ...
             <p className="text-muted-foreground">Riwayat transaksi kasir Anda akan muncul di sini.</p>
           </div>
        ) : (
